# PrepplusHub — Marketplace Frontend
...
- Vendor document upload stores filenames only (Cloudinary wiring still TODO).
- Real payment provider not integrated (checkout is demo card fields).
